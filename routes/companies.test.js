...
/************************************** GET /companies with search parameters */

describe('GET /companies with search parameters', function() {
	test('Get companies with just name search and wrong casing', async function() {
	...
	test('Search all min, max, and name', async function() {
		const resp = await request(app).get('/companies').send({
			name: 'c',
			maxEmployees: 3,
			minEmployees: 2
	...
	test('Search for more min than max 400s', async function() {
		const resp = await request(app).get('/companies').send({
			maxEmployees: 3,
			minEmployees: 4
		});
